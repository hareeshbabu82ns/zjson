...
public section.
  ...
  class-data GC_INT2_MAX type I value 32767. "#EC NOTEXT
  class CL_ABAP_MATH definition load .
  class-data GC_INT4_MAX type I value CL_ABAP_MATH=>MAX_INT4. "#EC NOTEXT
  class-data C_BOOLEAN_TYPES type STRING value `\TYPE-POOL=ABAP\TYPE=ABAP_BOOL#\TYPE=BOOLEAN#\TYPE=BOOLE_D#\TYPE=XFELD`. "#EC NOTEXT
